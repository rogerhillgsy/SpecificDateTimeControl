...
describe( 'Testing SpecificDatePicker functions', () => {
    ...
    test( 'Clearing date field should update date to be undefined', async () => {
        ...
        await waitFor(() => expect(getByTestId(container,"time") as HTMLInputElement).toHaveValue("15:57"));
        ...
        await waitFor(() => expect( datePicker.getOutputs().SpecificDateTimeField).toEqual(  new Date("2024-02-29T15:57") ));
    });
});